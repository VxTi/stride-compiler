 ...
 */
    ...
    void parsePartial(ASTNode *root, ast_token_set_t &token_set);

    ASTNode *parse(ast_token_set_t &token_set);
     ...
     * @return
     */
    static ASTNode *createComparison(ASTNode *left, ASTNode *right, token_type_t comparison);
